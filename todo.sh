...
[ -z "$ACTION" ]    && usage
[ -d "$TODO_DIR" ]  || dieWithHelp "$1" "Directory $TODO_DIR doesn't exist, to avoid syncthing-related issues not gonna create it automatically. Create that dir manually and retry."
